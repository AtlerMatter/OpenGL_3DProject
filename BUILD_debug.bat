...
:Compile
cl.exe /ZI /W4 /EHsc /MDd /Od /RTC1 /MP /fp:precise /sdl /Iinclude /Fedebug\\%CurrDir%_debug.exe /Fodebug\\ /Fddebug\\ %file% lib\\*.c /link /MACHINE:X64 lib\\*.lib gdi32.lib user32.lib kernel32.lib shell32.lib
